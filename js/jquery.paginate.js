$.fn.Paginate = function(pageNumber){
	 try
    {
		...
		if(typeof this.loader =='undefined') this.loader = '<div style="margin-left:40%;margin-top:15%;"><img src="../images/ajax-loader.gif" alt="loading" /></div">';
		...
		var url = "./templates/news_sub_page.php";
